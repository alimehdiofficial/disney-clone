...
function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-[70px] bg-[#090b13] flex justify-between items-center px-9 tracking-[16px] z-10">
      ...
      <button className="bg-opacity-60 py-2 px-4 uppercase tracking-widest border border-[#f9f9f9] rounded transition-all duration-200 ease-out hover:bg-[#f9f9f9] hover:text-black hover:border-transparent">
        Login
      </button>
    </nav>
  );
